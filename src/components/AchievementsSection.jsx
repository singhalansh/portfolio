...
const AchievementsSection = () => {
  ...
  const achievements = [
    ...
    },
    {
      ...
      image:
        "https://d8it4huxumps7.cloudfront.net/uploads/images/opportunity/banner/6795ac57d105e_algorance.webp?d=1920x557",
  ...
  return (
    ...
    <section
      className="py-24 bg-[var(--color-tertiary)] relative overflow-hidden"
      id="achievements"
    >
      {/* Background Elements */}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center mb-20">
          ...
          <p className="text-xl text-[var(--color-secondary)] max-w-3xl mx-auto leading-relaxed font-medium">
            Excellence recognized across India's most prestigious hackathons,
