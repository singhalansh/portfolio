...
const LetsTalkFooter = () => {
    ...
    return (
        <section className="bg-[var(--color-primary)] py-10 px-6" id="contact">
                    ...
                    <div className="space-y-12">
                        <div>
                            ...
                            <p className="text-[var(--color-secondary)] text-lg mt-6 leading-relaxed">
                                Let's learn from each other and make better
                                projects together.
                            </p>
                        </div>
                        ...
                        <div className="space-y-8">
                            <div className="flex items-center space-x-6">
                                ...
                                <a
                                    href="mailto:singhalansh155@gmail.com"
                                    className="text-[var(--color-white)] text-lg underline hover:text-[var(--color-secondary)] transition-colors duration-200"
                                >
